...
class CreateFinancialDepartment022Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('financial_department_02_2', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('surveying_number',50)->nullable();
    ...
    {
        Schema::dropIfExists('financial_department_02_2');
    }
}
