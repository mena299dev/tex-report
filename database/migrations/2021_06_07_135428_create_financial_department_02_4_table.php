...
class CreateFinancialDepartment024Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('financial_department_02_4', function (Blueprint $table) {
            $table->id();
            ...
            $table->float('fine_amount',20,2)->nullable();
    ...
    {
        Schema::dropIfExists('financial_department_02_4');
    }
}
