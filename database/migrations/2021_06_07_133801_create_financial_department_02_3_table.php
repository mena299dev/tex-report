...
class CreateFinancialDepartment023Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('financial_department_02_3', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('receive_number',50)->nullable();
    ...
    {
        Schema::dropIfExists('financial_department_02_3');
    }
}
