...
class FormCountController extends CrudController
{
    ...
    public function index(Request $request)
    {
        ...
        $fd = FormCount::where('year', $selected_year)
        ...
        $data['title'] = 'จำนวนแบบยื่น/จำนวนราย';
        ...
        return view('report.form-count')->with($data);
//        return view('export.fd02-01')->with($data);
    ...
    public function exportExcel($data)
    {
        ...
        return Excel::download(new \App\Exports\FD0204($data), 'form-count.xlsx');
    }

    public function exportPDF($data)
    {
        $pdf = PDF::loadView('export.form-count', [
            'fd' => $data['fd'],
        ...
        return $pdf->download('form-count.pdf');
    }
}
