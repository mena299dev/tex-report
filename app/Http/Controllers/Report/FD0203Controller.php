...
class FD0203Controller extends CrudController
{
    ...
    public function index(Request $request)
    {
        ...
        $fd = FD0203::where('year', $selected_year)
        ...
        return view('report.fd02-03')->with($data);
//        return view('export.fd02-01')->with($data);
    ...
    public function exportExcel($data)
    {
        ...
        return Excel::download(new \App\Exports\FD0203($data), 'fd02-03.xlsx');
    }
