        ...
        @if(!empty($saveAction['options']))
            <div class="btn-group" role="group">
                ...
                <button type="submit" class="btn btn-success">
                    ...
                    <span data-value="save_and_back">บันทึกและกลับหน้ารายการ</span>
                </button>

                &ensp;
                <button type="submit" class="btn btn-success">
                    <span class="la la-save" role="presentation" aria-hidden="true"></span> &nbsp;
                    <span data-value="save_and_edit">บันทึกและแก้ไข</span>
                </button>

                &ensp;
                <button type="submit" class="btn btn-success">
                    <span class="la la-save" role="presentation" aria-hidden="true"></span> &nbsp;
                    <span data-value="save_and_new">บันทึกและเพิ่มใหม่</span>
                </button>
