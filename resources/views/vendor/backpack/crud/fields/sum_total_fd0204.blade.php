    ...
    @push('crud_fields_scripts')
        <script>
            ...
            function sumTotalFD0204() {
                ...
                var fine_amount = parseFloat(document.getElementsByName("fine_amount")[0].value);
                var sum = tax_amount + increment_amount + fine_amount;
