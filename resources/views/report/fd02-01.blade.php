    ...
    <div>
        <table style="text-align:center;border: 1px solid black;border-collapse: collapse; width: 100%">
            ...
            <tr>
                ...
                <th style="border: 1px solid black;border-collapse: collapse">วันที่รับใบแจ้ง</th>
            ...
            @else
                @foreach($fd as $data)
                    <tr>
                        ...
                        <td style="border: 1px solid black;border-collapse: collapse">{{$data['date_of_notice'] ?\Carbon\Carbon::parse($data['date_of_notice'])->addYear(543)->format('d-m-Y'): null}}</td>
                        <td style="border: 1px solid black;border-collapse: collapse">{{$data['date_of_payment'] ?\Carbon\Carbon::parse($data['date_of_payment'])->addYear(543)->format('d-m-Y') : null}}</td>
